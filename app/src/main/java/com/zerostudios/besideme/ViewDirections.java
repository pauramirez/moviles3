...
import com.zerostudios.besideme.Helper.DirectionsJSONParser;
...
public class ViewDirections extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void drawPath(Location mLastLocation,  com.zerostudios.besideme.Model.Location location)
    {
        if(polyline!=null)
        {
            polyline.remove();
